 ...
 <div class="row">
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <strong>  <font color="red"> Doctor</font> Registration Form</strong>                         </header>
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="register_form" method="post" action="Controller">
                                      <input type="hidden" name="action" value="doctor_signup">
                                      ...
                                      <div class="form-group ">
                                          <label for="clinical_address" class="control-label col-lg-2">Clinical Address <span class="required">*</span></label>
                                          <div class="col-lg-10">
